...
export type CommandType = 'createEvents' | 'createTasks' | 'createShoppingItems' | 'createRecipes' | 'createMealPlans' | 'updateEvents' | 'updateTasks' | 'updateShoppingItems' | 'updateRecipes' | 'updateMealPlans' | 'deleteEvents' | 'deleteTasks' | 'deleteShoppingItems' | 'deleteRecipes' | 'deleteMealPlans' | 'getEvents' | 'getTasks' | 'getShoppingItems' | 'getRecipes' | 'getMealPlans' | 'searchEvents' | 'searchTasks' | 'searchShoppingItems' | 'searchRecipes' | 'searchMealPlans' | 'intelligentWebSearch' | 'writtingArticle';
interface IEvent {
    title: string;
    startTime: string;
    endTime: string;
